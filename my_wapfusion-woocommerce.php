...
/*
Plugin Name: WappFusion Woo
Plugin URI:  https://hoptrendy.org
Description: WappFusion enables automated and live agent 2-way messaging between businesses and its customers through various channels including WhatsApp.
Version:     2.0
Author:      Taimoor Rehman Siddiqui
Author URI:  https://hoptrendy.org
License:     GPLv3
License URI: http://www.gnu.org/licenses/gpl-3.0.html
Text Domain: my_wapfusion-woocommerce
*/
...
if ( ! defined( 'ZMPLGXX_NAME' ) ) {
	define("ZMPLGXX_NAME", "WappFusion Woo");
}

if ( ! defined( 'ZMPLGXX_SITENAME' ) ) {
	define("ZMPLGXX_SITENAME", "WappFusion");
}

if ( ! defined( 'ZMPLGXX_URL' ) ) {
	define("ZMPLGXX_URL", "https://wappfusion.com");
}

if ( ! defined( 'ZMPLGXX_DOMAIN' ) ) {
	define("ZMPLGXX_DOMAIN", "my_wapfusion-woocommerce");
}

if ( ! defined( 'ZMPLGXX_FREEMIUS' ) ) {
	define("ZMPLGXX_FREEMIUS", [
        "id" => "12467",
        "slug" => "messaging-sms-whatsapp",
        "public_key" => "pk_3a177d3eccbcc62adbd26e93510f0",
    ]);
}
